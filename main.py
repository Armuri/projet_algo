...
import livres 
import utilisateurs
from gestion import afficher_utilisateur
from gestion import ajouter_utilisateur
from gestion import supprimer_utilisateur
...
if a == str(1) : 
    ...
    admin = input('Bienvenue gestionnaire/admin, écrivez 1 pour recercher un utilisateur, 2 pour Ajouter unutlisatur,3 pour Supprimer un utilisateur, et q pour Quitter\n')
    if admin == str(1):
...
utilisateurs_data = utilisateurs.utilisateurs
